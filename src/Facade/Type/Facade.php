...
namespace Evrinoma\GalleryBundle\Facade\Type;

use Evrinoma\GalleryBundle\Manager\Type\CommandManagerInterface;
use Evrinoma\GalleryBundle\Manager\Type\QueryManagerInterface;
use Evrinoma\GalleryBundle\PreValidator\Type\DtoPreValidatorInterface;
