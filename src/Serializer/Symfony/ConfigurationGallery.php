...
class ConfigurationGallery implements ConfigurationInterface
{
    private string $fileName = '/src/Serializer/Symfony/yml/GalleryBundle/Model.Gallery.AbstractGallery.yml';
