...
interface GroupInterface
{
    ...
    public const API_DELETE_GALLERY = 'API_DELETE_GALLERY';
    ...
    public const API_POST_GALLERY_TYPE = 'API_POST_GALLERY_TYPE';
    public const API_PUT_GALLERY_TYPE = 'API_PUT_GALLERY_TYPE';
    public const API_DELETE_GALLERY_TYPE = 'API_DELETE_GALLERY_TYPE';
    public const API_GET_GALLERY_TYPE = 'API_GET_GALLERY_TYPE';
    public const API_CRITERIA_GALLERY_TYPE = self::API_GET_GALLERY_TYPE;
    public const APP_GET_BASIC_GALLERY_TYPE = 'APP_GET_BASIC_GALLERY_TYPE';

    public const API_POST_GALLERY_FILE = 'API_POST_GALLERY_FILE';
    public const API_PUT_GALLERY_FILE = 'API_PUT_GALLERY_FILE';
    public const API_DELETE_GALLERY_FILE = 'API_DELETE_GALLERY_FILE';
